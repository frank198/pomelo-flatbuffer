...
class FlatBuffer
{
	...
	check(type, route)
	{
		...
		switch(type) {
			case SERVER:
				...
				flatInstance = this[serverFlatBuffer][curRoute];
				break;
			case CLIENT:
				...
				flatInstance = this[cliteFlatBuffer][curRoute];
				break;
			default:
	...
	encode(route, message)
	{
		...
		const flatInstance = this[serverFlatBuffer][curRoute];
	...
	decode(route, message)
	{
		...
		const flatInstance = this[cliteFlatBuffer][curRoute];
		if (flatInstance != null)
		{
